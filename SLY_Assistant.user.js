    ...
    */
    ...
    async function execCompleteUpgrade(starbase, starbasePlayer, starbasePlayerCargoHoldsAndTokens, craftingProcess, userCraft) {
        return new Promise(async resolve => {
            ...
            console.log('keyIndex: ', new BrowserAnchor.anchor.BN(userProfileKeyIdx));
            console.log('upgradeProcessRecipeInputIndex: ', craftingRecipe.input[0].idx);
            console.log('starbaseUpgradeRecipeInputIndex: ', starbaseUpgradeRecipeInput.idx);
            console.log('resourceRecipeOutputIndex: ', itemRecipe.output.idx);
